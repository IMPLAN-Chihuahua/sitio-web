...
var snowStorm = (
    function (window, document) {
        ...
        this.animationInterval = 300;    // Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
        this.useGPU = true;             // Enable transform-based hardware acceleration, reduce CPU load.
        this.className = null;          // CSS class name for further customization on snow elements
        this.excludeMobile = true;      // Snow is likely to be bad news for mobile phones' CPUs (and batteries.) By default, be nice.
        this.flakeBottom = null;        // Integer for Y axis snow limit, 0 or null for "full-screen" snow effect
        this.followMouse = false;       // Snow movement can respond to the user's mouse
        this.snowColor = '#d7f3f6';     // Don't eat (or use?) yellow snow.
        ...
        features = (function () {
            ...
            function timeoutShim(callback) {
                window.setTimeout(callback, 4000 / (storm.animationInterval));
            }
        ...
        this.init = function () {
            ...
            storm.animationInterval = Math.max(storm.animationInterval / 1.5, storm.animationInterval);
            storm.timerInit();
        };
